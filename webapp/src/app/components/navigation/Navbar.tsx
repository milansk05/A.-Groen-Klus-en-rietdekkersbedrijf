                ...
                <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-md z-50">
                    <div className="container mx-auto px-4 py-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <Link href="/projecten" className="hover:text-primary" onClick={toggleMenu}>Projecten</Link>
                            <Link href="/over-ons" className="hover:text-primary" onClick={toggleMenu}>Over ons</Link>
